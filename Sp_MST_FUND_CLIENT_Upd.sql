create or replace PROCEDURE "SP_MST_FUND_CLIENT_UPD" (
		P_SEARCH_FUND_CODE		MST_FUND_CLIENT.FUND_CODE%TYPE,
		P_FUND_CODE		MST_FUND_CLIENT.FUND_CODE%TYPE,
		P_FUND_NAME		MST_FUND_CLIENT.FUND_NAME%TYPE,
		P_IM_CODE		MST_FUND_CLIENT.IM_CODE%TYPE,
		P_CLIENT_CD		MST_FUND_CLIENT.CLIENT_CD%TYPE,
		P_FUND_TYPE		MST_FUND_CLIENT.FUND_TYPE%TYPE,
		P_PORTFOLIO_ID		MST_FUND_CLIENT.PORTFOLIO_ID%TYPE,
		P_SELLER_TAX_ID		MST_FUND_CLIENT.SELLER_TAX_ID%TYPE,
		P_CRE_BY		MST_FUND_CLIENT.CRE_BY%TYPE,
		P_CRE_DT		MST_FUND_CLIENT.CRE_DT%TYPE,
		P_UPD_BY		MST_FUND_CLIENT.UPD_BY%TYPE,
		P_UPD_DT		MST_FUND_CLIENT.UPD_DT%TYPE,
...
v_table_name T_TEMP_HEADER.table_name%TYPE := 'MST_FUND_CLIENT';
...
CURSOR csr_table IS
SELECT *
FROM MST_FUND_CLIENT
WHERE FUND_CODE = P_SEARCH_FUND_CODE;

v_rec MST_FUND_CLIENT%ROWTYPE;
