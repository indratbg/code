create or replace 
PROCEDURE SPR_LAP_RINCIAN_PORTO_Upd(
	P_REPORT_DATE		LAP_MKBD_VD51.MKBD_DATE%TYPE,
	...
	v_table_name 				IPNEXTG.T_MANY_DETAIL.table_name%TYPE := 'LAP_RINCIAN_PORTO';
...
CURSOR csr_table IS
SELECT *
FROM LAP_RINCIAN_PORTO;

v_MANY_DETAIL  IPNEXTG.Types.MANY_DETAIL_rc;

v_rec LAP_RINCIAN_PORTO%ROWTYPE;
...
BEGIN
	...
	OPEN v_MANY_DETAIL FOR
		...
		( 
			SELECT  'REPORT_DATE'  AS field_name, TO_CHAR(P_REPORT_DATE,'yyyy/mm/dd hh24:mi:ss')  AS field_value, DECODE(v_rec.REPORT_DATE, P_REPORT_DATE,'N','Y') upd_flg FROM dual
