create or replace 
PROCEDURE SP_RECON_STK_BAL_001_004(P_SUBREK_TYPE VARCHAR2,
									P_BGN_STK VARCHAR2,
...
V_ERR EXCEPTION;
 ...
 BEGIN
   ...
   v_random_value := abs(dbms_random.random);
    ...
    BEGIN
        SP_RPT_REMOVE_RAND('R_RECON_STK_BAL_001_004',V_RANDOM_VALUE,V_ERROR_MSG,V_ERROR_CD);
    EXCEPTION
        WHEN OTHERS THEN
             V_ERROR_CD := -10;
	...
	BEGIN 
	INSERT INTO R_RECON_STK_BAL_001_004(SKEY,SUBREK004,CLIENT_CD,SUBREK001,STK_CD,
