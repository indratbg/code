create or replace PROCEDURE Sp_Ca_Jur_Sched IS
...
CURSOR CSR_APPROVE IS
	...
	--    Where update_date>=trunc(sysdate)--untuk test
...
AND V_TODAY BETWEEN X_DT AND RECORDING_DT;
...
-- ===========================================STK EXPIRED ========================
		...
		FOR REC IN CSR_SPLIT_REVERSE LOOP
				...
				BEGIN
			  	SP_CORP_ACT_X_DATE(V_TODAY,-- P_TODAY
								   REC.X_DT,-- P_X_DATE,
