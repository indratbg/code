create or replace 
PROCEDURE SP_TRADE_CONF(vp_update_date date,
...
--minfee
insert into TEMP_MINFEE 
 SELECT  b1.doc_date, 'R' R_I, b1.sl_acct_cd client_Cd, b1.db_cr_flg,
							SUM(DECODE(v.jur_type,'DCOMM',t.curr_val,0)) b_mf_comm, 
							SUM(DECODE(v.jur_type,'CCOMM',t.curr_val,0)) j_mf_comm, 
							SUM(DECODE(v.jur_type,'DPPNO',t.curr_val,'DPOSD',t.curr_val,0)) b_mf_vat, 
							SUM(DECODE(v.jur_type,'CPPNO',t.curr_val,'CPOSD',t.curr_val,0)) j_mf_vat, 
							SUM(DECODE(v.jur_type,'DCLIE',t.curr_val,0)) b_mf_amt, 
							SUM(DECODE(v.jur_type,'CCLIE',t.curr_val,0)) j_mf_amt, 
							SUM(DECODE(v.jur_type,'DCLIE',DECODE(SIGN(Get_Work_Days(t.doc_date, t.due_date) - 3),-1,0,t.curr_val),0)) b_t3_mf, 
							SUM(DECODE(v.jur_type,'CCLIE',DECODE(SIGN(Get_Work_Days(t.doc_date, t.due_date) - 3),-1,0,t.curr_val),0)) j_t3_mf, 
							SUM(DECODE(v.jur_type,'DCLIE',DECODE(Get_Work_Days(t.doc_date, t.due_date),2,t.curr_val,0),0)) b_t2_mf, 
							SUM(DECODE(v.jur_type,'CCLIE',DECODE(Get_Work_Days(t.doc_date, t.due_date),2,t.curr_val,0),0)) j_t2_mf, 
							SUM(DECODE(v.jur_type,'DCLIE',DECODE(Get_Work_Days(t.doc_date, t.due_date),1,t.curr_val,0),0)) b_t1_mf, 
							SUM(DECODE(v.jur_type,'CCLIE',DECODE(Get_Work_Days(t.doc_date, t.due_date),1,t.curr_val,0),0)) j_t1_mf,
							SUM(DECODE(v.jur_type,'DCLIE',DECODE(due_date,t.doc_date,t.curr_val,0),0)) b_t0_mf, 
							SUM(DECODE(v.jur_type,'CCLIE',DECODE(due_date,t.doc_date,t.curr_val,0),0)) j_t0_mf
  ...
  SELECT  a.contr_dt,a.r_i, a.client_cd, a.beli_jual, a.stk_cd, a.status, a.lot_size, a.qty, 
...
STOP_PAY
		...
		SELECT vp_update_date, vp_update_seq,c.client_name, NVL(c.contact_pers,c.client_name) contact_pers,   c.old_ic_num,
			   c.def_addr_1,  c.def_addr_2, c.def_addr_3, c.post_cd, 
				f.phone_num, f.phone2_1, f.hp_num, f.fax_num,f.hand_phone1, 
				 decode(c.stop_pay,'Y',f.e_mail1,c.e_mail1) e_mail1,--09aug2016
         c.print_flg, f.client_title, c.branch_code, 
			   ...
			   r.telex_num dealing_phone, r.post_cd AS br_post_cd, 	  
				...
				d.tc_id,	 f.npwp_no,  F_Sid(f.sid), F_Subrek(v.subrek001) subrek001, 
          ...
          DECODE(t.max_rg_t0,'0',t.max_ng_t0,DECODE(t.max_ng_t0,'0',t.max_rg_t0,t.max_rg_t0||'/'||t.max_ng_t0))mrkt_t0,
			   ...
			   t.contr_dt,t.r_i, t.client_cd, t.beli_jual, t.stk_cd, t.status, t.lot_size, t.qty, 
						t.price, t.brok_perc, t.whpph23_perc, t.brch_cd, t.rem_Cd, 
						t.b_val, t.j_val, t.b_comm, t.j_comm, t.b_vat, t.j_vat, 
						t.b_levy, t.j_levy, t.b_pph, t.j_pph, t.b_whpph23, t.j_whpph23, 
						t.pph_perc, t.mrkt_type, t.due_dt_for_amt, t.kpei_due_dt, 
t.sum_b_t3, t.sum_j_t3, t.sum_b_t2, t.sum_j_t2, t.sum_b_t1, t.sum_j_t1, t.sum_b_t0, t.sum_j_t0,
t.max_3plus, t.due_t3, t.due_t2, t.due_t1, t.max_rg_t3, t.max_rg_t2, t.max_rg_t1, t.max_rg_t0,
t.max_ng_t3, t.max_ng_t2, t.max_ng_t1, t.max_ng_t0, t.sum_b_amt, t.sum_j_amt, t.sum_b_val, t.sum_j_val, 
t.sum_b_comm, t.sum_j_comm, t.sum_b_vat, t.sum_j_vat, t.sum_b_levy, t.sum_j_levy, t.sum_b_pph, t.sum_j_pph, t.sum_b_whpph23 , t.sum_j_whpph23,
t.MRKT_TXT, n.stk_desc, vp_userid, 'E' APPROVED_STAT, NULL, NULL,
GET_DUE_DATE(1,t.due_dt_for_amt),G.CONTRACT_DEPT, C.STOP_PAY
        ...
        (SELECT DSTR1  AS CONTRACT_DEPT FROM MST_SYS_PARAM WHERE param_id='TRADE CONFIRMATION' and param_Cd1='CON_DEPT') G
