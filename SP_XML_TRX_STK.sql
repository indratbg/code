create or replace PROCEDURE SP_XML_TRX_STK(
    p_xml_type   varchar2, --OTC
    P_DUE_DT           DATE,
    p_id             varchar2,
    p_user_id R_XML.user_id%TYPE,
    p_menu_name R_XML.menu_name%TYPE, --OTC TUNAI,
    p_random_value number,--[INDRA]14-09-2017 UNTUK SELECT DATA DARI TABEL TEMP BERDASARKAN RANDOM VALUE
    p_error_code OUT NUMBER,
    p_error_msg OUT VARCHAR2 )
IS

CURSOR CSR_DATA IS
SELECT * FROM TMP_OTC where RAND_VALUE=P_RANDOM_VALUE AND USER_ID=p_user_id;
