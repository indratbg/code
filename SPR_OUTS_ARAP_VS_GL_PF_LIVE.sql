CREATE OR REPLACE
PROCEDURE SPR_OUTS_ARAP_GL_LIVE(
    P_BGN_DATE      DATE,
    P_END_DATE      DATE,
    P_OPTION        VARCHAR2,
...
--  
  ...
  FROM(       
        ...
        t.ori_amt,  
            ...
            FROM( 
        SELECT trim(t.sl_acct_Cd) sl_acct_Cd,doc_date,  t.xn_doc_num doc_ref_num,t.tal_id AS doc_tal_id,  
        doc_date AS jur_date, t.xn_doc_num,   
         t.tal_id,  
           trim(t.gl_acct_Cd) gl_acct_Cd,   
           DECODE(db_Cr_flg,'D',1,-1) * curr_val AS  ori_amt,   
           record_source ,    due_date, t.cre_DT, t.budget_cd   
        ...
        --order by 1,2  
        UNION ALL   
        SELECT trim(t.sl_acct_Cd) sl_acct_Cd,netting_date,  t.doc_ref_num, t.netting_flg AS doc_tal_id,   
        doc_date AS jur_date, t.xn_doc_num,   
        t.tal_id,   
           trim(t.gl_acct_Cd) gl_acct_Cd,   
           DECODE(db_Cr_flg,'D',1,-1) * curr_val AS  ori_amt,   
        ...
        (   
        SELECT d.sl_acct_Cd, d.doc_ref_num, doc_tal_id, gl_ref_num, DECODE(d.db_Cr_flg,'D',1,-1) * payrec_amt payrec_amt,  payrec_date,   
        payrec_num , d.tal_id, T_ACCOUNT_LEDGER.gl_acct_Cd, d.cre_dt  
        FROM T_PAYRECD d, T_ACCOUNT_LEDGER  
