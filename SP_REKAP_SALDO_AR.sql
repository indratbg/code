CREATE OR REPLACE PROCEDURE SP_REKAP_SALDO_AR(
    P_DATE          DATE,
    P_USER_ID       VARCHAR2,
...
BEGIN
  ...
  vp_from_dt := TO_DATE('01'||TO_CHAR(P_DATE,'MMYYYY'),'DDMMYYYY');
  ...
  BEGIN
    ...
    SELECT a.brch_cd, brch_name, s_amt, t_amt, m_amt, tot_amt, P_USER_ID, P_RANDOM_VALUE,P_GENERATE_DATE
    FROM
      (
