create or replace PROCEDURE Sp_Stk_Otc_Upd_NEW(p_Doc_num T_STK_MOVEMENT.doc_num%TYPE,
...
END;
   ...
   IF v_cnt = 0  THEN
		...
		VALUES ( p_settle_date, p_client_Cd, SUBSTR(p_doc_num,5,1),
		    ...
		    p_amount, SYSDATE,p_user_id, p_to_client , p_xml_flg);
		EXCEPTION
		WHEN OTHERS THEN
			 v_error_code := -20;
