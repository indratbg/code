create or replace PROCEDURE SP_INSERT_DAILY_OTC_JUR(
    ...
    P_XN_DOC_NUM T_DAILY_OTC_JUR.XN_DOC_NUM%TYPE,	
	   P_OTC_FEE T_DAILY_OTC_JUR.OTC_FEE%TYPE,
...
BEGIN
  ...
  BEGIN
    ...
    INTO T_DAILY_OTC_JUR
      (
        JUR_DATE, DOC_NUM, CLIENT_CD, SUM_OTC, TIDAK_DIJURNAL, XN_DOC_NUM, USER_ID, CRE_DT,OTC_FEE)
      VALUES
      (
        P_JUR_DATE, P_DOC_NUM,P_CLIENT_CD,P_SUM_OTC,P_TIDAK_DIJURNAL,P_XN_DOC_NUM,P_USER_ID,SYSDATE,P_OTC_FEE
      );
  EXCEPTION
  WHEN OTHERS THEN
    V_ERROR_CODE :=-15;
