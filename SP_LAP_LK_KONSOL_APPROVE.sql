create or replace 
PROCEDURE SP_LAP_LK_KONSOL_APPROVE(
...
BEGIN
	...
	BEGIN
	UPDATE LAP_LK_KONSOL SET APPROVED_STAT ='A',approved_by=p_approved_user_id, APPROVED_DT = SYSDATE WHERE UPDATE_SEQ=P_UPDATE_SEQ AND UPDATE_DATE=P_UPDATE_DATE;
	EXCEPTION
			WHEN OTHERS THEN
				v_error_code := -3;
