create or replace 
FUNCTION F_GET_FOLDER_NUM_REV_GL  (p_doc_date   DATE,
			...
			(
				...
				(
					SELECT DECODE(field_name,'FOLDER_CD',field_value, NULL) FOLDER_CD,
							DECODE(field_name,'JVCH_DATE',field_value, NULL) FLD_MON,
					...
					WHERE TABLE_NAME = 'T_JVCHH'
					AND FIELD_NAME IN ('FOLDER_CD','JVCH_DATE')
